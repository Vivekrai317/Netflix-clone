    ...
    <div className='bg-black min-h-screen text-white '>
        ...
        <div className='container mx-auto px-4 py-8'>
            <div className='flex justify-center gap-3 mb-4'>
                ...
                <button
                className={`py-2 px-4 rounded ${activeTab==="artist"? "bg-red-600" : "bg-gray-800" } hover:bg-red-700`}
                    ...
                    return (
                        <div key={result.id} className='bg-gray-800 p-4 rounded'>
                            {activeTab==="person"?(
                                ...
                                <h2 className='mt02 text0xl font-bold'>{result.name}</h2>
                                </Link>
                            ):
                            (
                                ...
                                onClick={()=>setContentType(activeTab)}>
                                    ...
                                    />
                                    <h2 className='text-center mt-2 text-xl font-bold'>{result.title || result.name}</h2>
                                </Link>
                            )
                            }
                        </div>
