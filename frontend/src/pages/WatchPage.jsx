...
const WatchPage = () => {
    ...
    const [currentTrailerIndex,setCurrenTrailerIndex] = useState(0)
    ...
    const handleNext=()=>{
        ...
        setCurrenTrailerIndex(currentTrailerIndex+1);
    }
    const handlePrev=()=>{
                    ...
                    {similarContent.map((content)=>{
                        ...
                        return(
                            ...
                            className='flex-none w-52'>
                                <img src={SMALL_IMG_BASE_URL + content.poster_path} alt=""
